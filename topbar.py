...
def topbar():
    ...
    Div(botaoMenu('Ver OBS','listaobs'), botaoMenu('Criar OBS','procurarcliente'), style='display: flex; align-items: center;'), style="display: flex; justify-content: space-between")
